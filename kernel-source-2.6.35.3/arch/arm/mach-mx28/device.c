...
static struct gpmi_nfc_platform_data  gpmi_nfc_platform_data = {
	...
	.max_chip_count          = 2,
	.boot_area_size_in_bytes = 3 * SZ_1M, // ssen - changed this to 3MB from 20MB.
...
static int mxs_mmc_get_wp_ssp0(void)
{
   ...
   return 1; //ssen - changed this to always return disabled.
}
...
out_wp:
	//return ret;
        return 0; //ssen - changed this to always return success
