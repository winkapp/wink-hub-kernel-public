...
static struct nand_device_mfr_info  nand_device_mfr_directory[] __initdata = {
	...
	{
	.id = NAND_MFR_AMD,
	.fn = nand_device_info_fn_stmicro, //ssen - added in Spansion NAND support
	},
	{
	.id = NAND_MFR_SANDISK,
	...
	{
	.id = NAND_MFR_MACRONIX,			//ssen - Added in Macronix NAND support
	.fn = nand_device_info_fn_stmicro,  //ssen - Re-using the stmicro NAND function
	},
	{
	.id = NAND_MFR_INTEL,
